namespace eWoW.Network.OpCodes
{
    ...
    public enum RealmServerOpCode : ushort
    {
        ...
        /// <summary>
        /// MapID, Error 1 - 3 (1: Instance full, 2: Not Found, 3: To many instance recently)
        /// </summary>
        ...
        /// <summary>
        /// Inspect other Character's Talents
        /// </summary>
        CMSG_INSPECT = 276,
        SMSG_INSPECT = 277,
        ...
        SMSG_COMBAT_XP_GAIN_OBSOLETE = 335,
        SMSG_HEALSPELL_ON_OBSOLETE = 336,
        ...
        CMSG_MACRO_OBSOLETE = 483,
        SMSG_MACRO_OBSOLETE = 484,
        CMSG_GHOST = 485,
        CMSG_GM_INVIS = 486,

        CMSG_SCREENSHOT_OBSOLETE = 487, //OBSOLETE
        ...
        SMSG_RESET_STATE = 679,
        CMSG_REPAIR_ITEM = 680,
        SMSG_CHAT_NOT_FOUND = 681,
        ...
        MSG_BATTLEGROUND_POSITIONS = 745,
        CMSG_PET_STOP_ATTACK = 746,
        SMSG_BINDER_CONFIRM = 747,
        SMSG_BATTLEGROUND_JOINED = 748,
        SMSG_BATTLEGROUND_LEFT = 749,
        ...
        SMSG_UNKNOWN_765 = 765,
        // Trial accounts can not send unlimited tells, you must wait before you can send tells to more players.
        ...
        // movement related, looks like hover, movement flag 0x40000000, we can't jump if we are lands
        ...
        // 789
        // 790
        CMSGWATCHED_FACTION_INACTIVE = 791,
        CMSGWATCHED_FACTION_SHOW_BAR = 792,
        SMSG_UNKNOWN_793 = 793, // packed guid + uint32 unk
        SMSG_UNKNOWN_794 = 794,
        // packed guid, movement related, set 0x1000 movement flag, all speed to 0, except turn rate
        // 795
        ...
        SMSG_INSTANCE_SAVE = 800, // uint32 mapid, instance related (save?)
        MSG_RAID_ICON_TARGET = 801, // uint8+uint8+uint64 guid OR only uint8(0x01 or 0xFF)
        ...
        SMSG_INSTANCE_RESET_ACTIVATE = 811, // uint32 mapid, 0x0, SMSG_INSTANCE_RESET_ACTIVATE ?
        // 812
        // 813
        // 814
        SMSG_UNKNOWN_815 = 815, // spell related, uint64 guid + spellid (You are killed by spell_name)
        SMSG_UNKNOWN_816 = 816,
        // spell related, uint64 guid + spellid + uint32 count + for(count) uint64 guid (target?)
        // 817
        SMSG_ANTISPAM = 818,
        // 2.0.8, received before server MOTD, strange regexp sequence, looks like anti spam filter for chat messages...
        // 819
        // 820
        // 821
        // 822
        ...
        CMSG_SOCKET_ITEM = 839,
        // click on "Socket Gems" button in Jewelcrafting UI, contains uint64 item guid + 3 x uint64 gems guid's
        // 840, CMSG?
        ...
        // realm related, uint32, appears at select character screen, uint32 0xFFFFFFFF by default
        ...
        SMSG_TICK_QUERY = 912,
        // uint32, allow player movement, value increments every time and reset to 0 after far teleport, used for client-server synchronization
        CMSG_TICK_QUERY_RESPONSE = 913, // client response to SMSG_ALLOW_MOVE (counter + client time)
        // 914
        // 915
        // 916
        // 917
        SMSG_INSTANCE_RESET_FAILURE = 918,
        // chat message: The party leader has attempted to reset the instance you are in. Please zone out to allow the instance to reset.
        ...
        // 966
        SMSG_967 = 967, // Complaint Registered: If first argument = 2
        SMSG_VOICE_SYSTEM_STATUS_UPDATE, // byte, byte
        // 969
